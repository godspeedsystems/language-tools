...
export async function activate(context: vscode.ExtensionContext) {
  ...
  // const corePackageInfo = await getPackageInfo('@godspeedsystems/core');

  // const coreLatestVersion = corePackageInfo['dist-tags'].latest;
  // if (semver.gte(extensionVersion, '2.0.0') || extensionVersion === coreLatestVersion) {
  //   // Your activation logic here
  //   console.log(`Extension activated for version: ${extensionVersion}`);
  // } else {
  //   console.log(`Extension not activated for version: ${extensionVersion}`);
  // }
