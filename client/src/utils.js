...
exports.installYAMLConfigurations = void 0;
/* eslint-disable @typescript-eslint/naming-convention */
var path = require("path");
var vscode = require("vscode");
var showDialog = vscode.window.showInformationMessage;
var isDevMode = function (context) {
    return context.extensionMode === vscode.ExtensionMode.Development
        ? true
        : false;
};
var getDefaultSettings = function (context) {
    if (isDevMode(context)) {
        var schemaFolderPath_1 = path.join(context.extensionPath, "/schemas/");
        var mappings = [
        ...
        return {
            "yaml.schemas": __assign({}, mappings.reduce(function (acc, mapping) {
                var key = path.join(schemaFolderPath_1, mapping.schemaFile);
                var value = mapping.globPattern;
                acc[key] = value;
                return acc;
            }, {})),
        };
...
var installYAMLConfigurations = function (context) {
    var defaultLanguageSettings = getDefaultSettings(context);
    Object.keys(defaultLanguageSettings).forEach(function (key) { return __awaiter(void 0, void 0, void 0, function () {
        var value;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    value = defaultLanguageSettings[key];
...
exports.installYAMLConfigurations = installYAMLConfigurations;
